/*
  ==============================================================================
    ...
    BlueKnobLookAndFeel.h
    Created: 9 Jul 2021 11:42:54pm
    Author:  Adam Murdock
...
#pragma once
class VioletKnobLookAndFeel : public juce::LookAndFeel_V4
{
public:
	VioletKnobLookAndFeel() {
	...
	//		juce::Colour fill = juce::Colour(255,255,255);
			juce::Colour fill = juce::Colour(140,61,230);
			g.setColour (fill);
